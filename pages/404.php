<main class="mx-auto flex min-h-screen max-w-xl items-center p-4 sm:p-6">
  <section class="ght-card t-resize w-full">
    ...
    <h1 class="ght-display mb-0 mt-2 text-4xl">Page not found.</h1>
    <p class="mb-0 mt-4 text-sm leading-6 text-[#737373]">The page you are looking for does not exist or may have moved.</p>
    <div class="mt-7">
